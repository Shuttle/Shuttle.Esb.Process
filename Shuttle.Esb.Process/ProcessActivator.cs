...
namespace Shuttle.Esb.Process
{
    public class ProcessActivator : IProcessActivator
    {
        ...
        private readonly Dictionary<Type, List<MessageProcessType>> _mappings = new Dictionary<Type, List<MessageProcessType>>();
        ...
        private readonly Dictionary<Type, Func<TransportMessage, object, MessageProcessType>> _resolvers = new Dictionary<Type, Func<TransportMessage, object, MessageProcessType>>();
        ...
        public IProcessActivator RegisterResolver<TMessageType>(Func<TransportMessage, object, MessageProcessType> resolver)
        {

...
namespace Shuttle.Esb.Process
{
	public class ProcessConfigurationObserver : IPipelineObserver<OnInitializing>
	{
		...
		public ProcessConfigurationObserver(IDatabaseContextFactory databaseContextFactory, IEventStore eventStore,
			IKeyStore keyStore, IProcessConfiguration configuration)
		{
